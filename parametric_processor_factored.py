...
# keys_of_interest = ['Nx_diff', 'Nz_diff', 'Nz_diff', 'Dyy', 'Dzz', 'p_yy']
keys_of_interest = ['p_xy', 'p_yy', 'phi']
# keys_of_interest = ['vx_fluctuations', 'vy_fluctuations', 'vz_fluctuations', 'vx_div_vy', 'vx_div_vz', 'rke', 'tke', 'rke_div_tke']
# keys_of_interest = ['total_normal_dissipation', 'total_tangential_dissipation']
# keys_of_interest = ['S2', 'thetax_mean', 'Omega_z']
# keys_of_interest = ['c_delta_vy', 'c_r_values', 'box_x_length', 'box_y_length', 'box_z_length']
os.chdir("./output_data_dataset")
# os.chdir("./output_data_26_02_2025")
# os.chdir("./output_data_dt_0.08")

data = load_data(aspect_ratios, cofs, Is, keys_of_interest)
output_dir = "../parametric_plots_elastic"
