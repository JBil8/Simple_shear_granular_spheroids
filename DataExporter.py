...
class DataExporter:
    ...
    def export_data(self, data_vtk, data_dump):
        ...
        np.savetxt(
            self.directory + '/simple_shear_ap' + self.ap + '_cof_' + self.cof + '_' + self.parameter + '_' + self.value + '.csv',
        ...
        np.savetxt(
            self.directory + '/simple_shear_ap' + self.ap + '_cof_' + self.cof + '_' + self.parameter + '_' + self.value + '_eulerian_velocities.csv',
